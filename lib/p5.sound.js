...
(function (root, factory) {
  ...
  */
  ...
  soundfile = (function () {
     ...
     * Larger arrays result in more precise waveform Visualisations.
     *
  ...
  Tone_type_Time = (function (Tone) {
    ...
    Tone.Time.prototype.toNotation = function () {
      ...
      if (
        retTripletNotation.split("+").length < retNotation.split("+").length
      ) {
  ...
  Tone_type_Frequency = (function (Tone) {
    ...
    Tone.Frequency.prototype._ticksToUnits = function (ticks) {
      return (
        1 / ((ticks * 60) / (Tone.Transport.bpm.value * Tone.Transport.PPQ))
      );
    };
  ...
  Tone_signal_Expr = (function (Tone) {
    ...
    Tone.Expr.prototype._parseTree = function (expr) {
      ...
      function parseFunctionCall(func) {
        ...
        if (!matchSyntax(token, "(")) {
          throw new SyntaxError(
            'Tone.Expr: Expected ( in a function call "' + func.value + '"'
          );
        }
        token = lexer.peek();
        if (!matchSyntax(token, ")")) {
  ...
  polysynth = (function () {
    ...
    p5.PolySynth.prototype.noteRelease = function (_note, secondsFromNow) {
      ...
      if (this.notes[note].getValueAtTime(t) === null) {
        ...
        this._newest =
          this._newest === 0 ? 0 : (this._newest - 1) % (this.polyValue - 1);
      }
    };
    /**
     *  Connect to a p5.sound / Web Audio object.
